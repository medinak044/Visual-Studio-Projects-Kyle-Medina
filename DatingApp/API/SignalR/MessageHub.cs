...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        private async Task<Group> AddToGroup(string groupName)
        {
            ...
            throw new HubException("Fauked to join group");
        }
        ...
        private string GetGroupName (string caller, string other)
        {
            ...
            return stringCompare ? $"{caller}-{other}" : $"{other}-{caller}"; // Ensures groupname is always in alphabetical order for both caller and the other
        }
    }
}
