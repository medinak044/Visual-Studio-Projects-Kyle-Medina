    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserConnectionRequests", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemRequests_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemRecordUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemRecordUsers_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemRecordUsers_ItemRecords_ItemRecordId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemRecordUsers_AppUserId",
                table: "ItemRecordUsers",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemRecordUsers_ItemRecordId",
                table: "ItemRecordUsers",
                column: "ItemRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemRequests_AppUserId",
                table: "ItemRequests",
                column: "AppUserId");
